...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Aitcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"127.0.0.1", "213.208.150.72"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"aitcointools.com", "testnet-seed.aitcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Aitcoin is probably already running."), addrBind.ToString().c_str());
        else
